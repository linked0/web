...
export function AIAgent({ onPlanetSelect }: AIAgentProps) {
    ...
    return (
        <div className="fixed bottom-6 right-6 w-96 max-h-[500px] flex flex-col glass rounded-2xl overflow-hidden shadow-2xl z-50 pointer-events-auto">
            <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/5">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="font-semibold text-sm text-white">Gemini Flash Guide</h3>
            ...
            <div className="p-4 bg-white/5 border-t border-white/10">
                <div className="relative">
                    <input
                        ...
                        className="w-full bg-black/40 border border-white/10 rounded-xl py-2.5 pl-4 pr-12 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors"
                    />
                    <button
                        onClick={handleSend}
                        disabled={isLoading}
