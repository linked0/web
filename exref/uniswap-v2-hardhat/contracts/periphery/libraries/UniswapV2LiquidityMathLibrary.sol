...
import "../../pooh-swap-lib/libraries/Babylonian.sol";
import "../../pooh-swap-lib/libraries/FullMath.sol";
...
library UniswapV2LiquidityMathLibrary {
    ...
    function getReservesAfterArbitrage(
        ...
        if (aToB) {
            uint256 amountOut =
                UniswapV2Library.getAmountOut(amountIn, reserveA, reserveB);
            reserveA += amountIn;
            reserveB -= amountOut;
        } else {
            uint256 amountOut =
                UniswapV2Library.getAmountOut(amountIn, reserveB, reserveA);
            reserveB += amountIn;
            reserveA -= amountOut;
        }
    }
