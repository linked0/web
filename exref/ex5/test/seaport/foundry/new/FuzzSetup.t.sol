...
import {FuzzParams, FuzzTestContext, FuzzTestContextLib} from "./helpers/FuzzTestContextLib.sol";
...
contract FuzzSetupTest is BaseOrderTest, FuzzSetup {
  ...
  function test_setUpOfferItems_erc20() public {
    ...
    // for.
    context.executionState.orderDetails[0].unavailableReason = UnavailableReason
      .AVAILABLE;
