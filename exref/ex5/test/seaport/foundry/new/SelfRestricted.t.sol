...
import {AdvancedOrderLib, ConsiderationItemLib, CriteriaResolver, FulfillmentComponentLib, FulfillmentLib, OfferItemLib, OrderComponentsLib, OrderLib, OrderParametersLib, SeaportArrays} from "seaport-sol/src/SeaportSol.sol";
...
contract SelfRestrictedTest is BaseOrderTest {
    ...
    )
  {
    ...
    advancedOrder = createOpenConsiderErc20(context, offerer1, considerAmount);
  ...
  function createOpenConsiderErc20(
    ...
    bytes memory signature = signOrder(context.seaport, account.key, orderHash);
