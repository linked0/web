...
abstract contract $GovernorTimelockCompound is GovernorTimelockCompound {
    ...
    function $_queueOperations(uint256 proposalId,address[] calldata targets,uint256[] calldata values,bytes[] calldata calldatas,bytes32 arg4) external returns (uint48 ret0) {
