...
import {AdvancedOrder, ConsiderationItem, CriteriaResolver, MemoryPointer, OfferItem, OrderParameters} from "../../../seaport-types/src/lib/ConsiderationStructs.sol";

import {_revertCriteriaNotEnabledForItem, _revertInvalidProof, _revertOrderCriteriaResolverOutOfRange} from "../../../seaport-types/src/lib/ConsiderationErrors.sol";

import {CriteriaResolutionErrors} from "../../../seaport-types/src/interfaces/CriteriaResolutionErrors.sol";

import {OneWord, OneWordShift, OrderParameters_consideration_head_offset, Selector_length, TwoWords} from "../../../seaport-types/src/lib/ConsiderationConstants.sol";

import {ConsiderationCriteriaResolverOutOfRange_err_selector, Error_selector_offset, OfferCriteriaResolverOutOfRange_error_selector, UnresolvedConsiderationCriteria_error_itemIndex_ptr, UnresolvedConsiderationCriteria_error_length, UnresolvedConsiderationCriteria_error_orderIndex_ptr, UnresolvedConsiderationCriteria_error_selector, UnresolvedOfferCriteria_error_selector} from "../../../seaport-types/src/lib/ConsiderationErrorConstants.sol";
...

        {
          ...
          if (criteriaResolver.side != Side.OFFER) {
            ...
            MemoryPointer considerationPtr = orderParameters
              .toMemoryPointer()
              .pptrOffset(OrderParameters_consideration_head_offset);
    ...
    for (uint256 i = 0; i < totalItems; ++i) {
      ...
      assembly {
        if and(
          ...
          mstore(UnresolvedConsiderationCriteria_error_itemIndex_ptr, i)
