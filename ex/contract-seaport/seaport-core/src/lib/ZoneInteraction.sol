...
import {authorizeOrder_selector_offset, BasicOrder_zone_cdPtr, ContractOrder_orderHash_offerer_shift, MaskOverFirstFourBytes, OneWord, OrderParameters_salt_offset, OrderParameters_zone_offset, validateOrder_selector_offset} from "../../../seaport-types/src/lib/ConsiderationConstants.sol";

import {Error_selector_offset, InvalidContractOrder_error_selector, InvalidRestrictedOrder_error_length, InvalidRestrictedOrder_error_orderHash_ptr, InvalidRestrictedOrder_error_selector} from "../../../seaport-types/src/lib/ConsiderationErrorConstants.sol";
  ...
  LowLevelHelpers
{
  ...
  function _assertRestrictedBasicOrderValidity(
    ...
    if (
      ...
      uint256 memoryLocationForOrderHashes = (sizeAndMemoryLocationForOrderHashes &
          OffsetOrLengthMask);
