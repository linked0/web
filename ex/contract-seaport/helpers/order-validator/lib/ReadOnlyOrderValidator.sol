...
import {Order, OrderComponents, OrderParameters, OrderStatus} from "../../../seaport-types/src/lib/ConsiderationStructs.sol";

import {_revertConsiderationLengthNotEqualToTotalOriginal, _revertMissingOriginalConsiderationItems} from "../../../seaport-types/src/lib/ConsiderationErrors.sol";

import {SignatureVerification} from "../../../seaport-core/src/lib/SignatureVerification.sol";

import {_revertOrderAlreadyFilled, _revertOrderIsCancelled, _revertOrderPartiallyFilled} from "../../../seaport-types/src/lib/ConsiderationErrors.sol";

import {SeaportInterface} from "../../../seaport-sol/src/SeaportInterface.sol";

import {BulkOrder_Typehash_Height_One, BulkOrder_Typehash_Height_Two, BulkOrder_Typehash_Height_Three, BulkOrder_Typehash_Height_Four, BulkOrder_Typehash_Height_Five, BulkOrder_Typehash_Height_Six, BulkOrder_Typehash_Height_Seven, BulkOrder_Typehash_Height_Eight, BulkOrder_Typehash_Height_Nine, BulkOrder_Typehash_Height_Ten, BulkOrder_Typehash_Height_Eleven, BulkOrder_Typehash_Height_Twelve, BulkOrder_Typehash_Height_Thirteen, BulkOrder_Typehash_Height_Fourteen, BulkOrder_Typehash_Height_Fifteen, BulkOrder_Typehash_Height_Sixteen, BulkOrder_Typehash_Height_Seventeen, BulkOrder_Typehash_Height_Eighteen, BulkOrder_Typehash_Height_Nineteen, BulkOrder_Typehash_Height_Twenty, BulkOrder_Typehash_Height_TwentyOne, BulkOrder_Typehash_Height_TwentyTwo, BulkOrder_Typehash_Height_TwentyThree, BulkOrder_Typehash_Height_TwentyFour, BulkOrderProof_keyShift, BulkOrderProof_keySize, BulkOrderProof_lengthAdjustmentBeforeMask, BulkOrderProof_lengthRangeAfterMask, BulkOrderProof_minSize, BulkOrderProof_rangeSize, ECDSA_MaxLength, EIP_712_PREFIX, EIP712_DigestPayload_size, EIP712_DomainSeparator_offset, EIP712_OrderHash_offset, OneWord, OneWordShift, ThirtyOneBytes, TwoWords} from "../../../seaport-types/src/lib/ConsiderationConstants.sol";
...
contract ReadOnlyOrderValidator is SignatureVerification {
  ...
  function _deriveOrderHash(
    ...
    return seaport.getOrderHash(_toOrderComponents(orderParameters, counter));
  }
