...
import {AdvancedOrder, ConsiderationItem, CriteriaResolver, OfferItem, Order, OrderComponents, OrderParameters, OrderType, ReceivedItem, SpentItem} from "../../../../seaport-types/src/lib/ConsiderationStructs.sol";
...
contract AmountDeriverHelper is AmountDeriver {
  ...
  function getSpentItems(
    ...
    return
      getSpentItems(parameters.offer, parameters.startTime, parameters.endTime);
  }
