...
import {AdvancedOrder, CriteriaResolver, Execution, FulfillmentComponent} from "../seaport-types/src/lib/ConsiderationStructs.sol";
...
contract SeaportRouter is SeaportRouterInterface, ReentrancyGuard {
  ...
  function _assertSeaportAllowed(address seaport) internal view {
    if (
      _cast(seaport == _SEAPORT_V1_5) | _cast(seaport == _SEAPORT_V1_6) == 0
    ) {
