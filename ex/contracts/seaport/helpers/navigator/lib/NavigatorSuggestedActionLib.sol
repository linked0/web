...
import {AdvancedOrder, ReceivedItem, SpentItem} from "../../../seaport-types/src/lib/ConsiderationStructs.sol";
...
library NavigatorSuggestedActionLib {
  ...
  function suggestedCallData(
    ...
    bool cannotMatch = (context.response.unmetConsiderationComponents.length !=
      0 ||
