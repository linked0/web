        ...
        let invalidEncoding := iszero(
          and(
            ...
            and(
              ...
              eq(
                calldataload(
                  add(elementPtr, ConduitBatchTransfer_amounts_head_offset)
                ),
