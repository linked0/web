...
import {AdvancedOrder, ConsiderationItem, CriteriaResolver, OfferItem, OrderParameters, ReceivedItem, SpentItem} from "../../../seaport-types/src/lib/ConsiderationStructs.sol";
...
import {_revertInsufficientNativeTokensSupplied, _revertInvalidNativeOfferItem} from "../../../seaport-types/src/lib/ConsiderationErrors.sol";

import {AccumulatorDisarmed, ConsiderationItem_recipient_offset, ReceivedItem_amount_offset, ReceivedItem_recipient_offset} from "../../../seaport-types/src/lib/ConsiderationConstants.sol";
  ...
  AmountDeriver
{
  ...
  function _validateAndFulfillAdvancedOrder(
    ...
    _applyFractions(orderParameters, fillNumerator, fillDenominator, recipient);
