...
import {Order, OrderParameters, ZoneParameters} from "../../../seaport-types/src/lib/ConsiderationStructs.sol";
...
interface SeaportValidatorInterface {
  ...
  function getApprovalAddress(
    bytes32 conduitKey,
    address seaportAddress
  ) external view returns (address, ErrorsAndWarnings memory errorsAndWarnings);
