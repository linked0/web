...
import {AggregatableConsideration, ProcessComponentParams, MatchFulfillmentStorageLayout, AggregatableOfferer} from "../lib/Structs.sol";
...
library MatchFulfillmentLib {
  ...
  function aggregatableOffererExists(
    ...
    return
      layout
      .offerMap[token][tokenId][offerer.offerer][offerer.conduitKey].length > 0;
  }
