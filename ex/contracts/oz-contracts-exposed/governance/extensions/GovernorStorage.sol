...
abstract contract $GovernorStorage is GovernorStorage {
    ...
    function $_propose(address[] calldata targets,uint256[] calldata values,bytes[] calldata calldatas,string calldata description,address proposer) external returns (uint256 ret0) {
    ...
    function $_queueOperations(uint256 arg0,address[] calldata arg1,uint256[] calldata arg2,bytes[] calldata arg3,bytes32 arg4) external returns (uint48 ret0) {
        (ret0) = super._queueOperations(arg0,arg1,arg2,arg3,arg4);
        emit return$_queueOperations(ret0);
    }

    function $_executeOperations(uint256 arg0,address[] calldata targets,uint256[] calldata values,bytes[] calldata calldatas,bytes32 arg4) external {
