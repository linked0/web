...
import {Order, OrderParameters, OrderComponents, FulfillmentComponent} from "seaport-types/src/lib/ConsiderationStructs.sol";
...
contract MatchOrders is BaseOrderTest {
  ...
  function matchOrdersSingleErc721OfferSingleEthConsideration(
    ...
    OrderParameters memory mirrorOrderParameters = createMirrorOrderParameters(
      baseOrderParameters,
      cal,
      context.args.zone,
      conduitKey
