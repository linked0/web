...
import {FractionUtil, FractionResults, FractionStatus} from "./helpers/FractionUtil.sol";
...
contract FractionUtilTest is Test {
  ...
  function testGetPartialFillResults() public {
    ...
    assertEq(results1.realizedNumerator, 2, "Realized numerator should be 2");
    assertEq(
  ...
  function testGetWholeFillResultsGCD() public {
    ...
    assertEq(results2.realizedNumerator, 1, "Realized numerator should be 1");
    assertEq(
  ...
  function testGetPartialFillResultsGCD() public {
    ...
    assertEq(results3.realizedNumerator, 1, "Realized numerator should be 1");
    assertEq(
  ...
  function testGetInvalidResults() public {
    ...
    assertEq(results4.realizedNumerator, 0, "Realized numerator should be 0");
    assertEq(
