...
import {ArrayHelpers, MemoryPointer} from "../../../../../contracts/helpers/ArrayHelpers.sol";
...
library ExpectedEventsUtil {
  ...
  function checkExpectedTransferEvents(
    ...
    int256 nextWatchedEventIndex = ArrayHelpers.findIndexFrom.asLogsFindIndex()(
      logs,
  ...
  function isWatchedSeaportEvent(
    ...
    bytes32 topic0 = log.getTopic0();
    return
      topic0 == OrderFulfilled.selector || topic0 == OrdersMatched.selector;
  }
