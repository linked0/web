...
import {ConsiderationItemLib, FulfillmentComponentLib, OfferItemLib, OrderComponentsLib, OrderLib, OrderParametersLib, SeaportArrays} from "seaport-sol/src/SeaportSol.sol";

import {ConsiderationItem, Fulfillment, FulfillmentComponent, OfferItem, Order, OrderComponents, OrderParameters} from "seaport-sol/src/SeaportStructs.sol";
...
import {MatchComponent, MatchComponentType} from "seaport-sol/src/lib/types/MatchComponentType.sol";
...
contract MatchFulfillmentHelperTest is BaseOrderTest {
  ...
  function execGetMatchedFulfillments_1ItemTo1Item(
    ...
    Order memory order = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(100)
          )
        )
        .withTotalConsideration(
          SeaportArrays.ConsiderationItems(
    ...
    Order memory otherOrder = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[1])).withAmount(100)
          )
        )
        .withTotalConsideration(
          SeaportArrays.ConsiderationItems(
    ...
    if (useDifferentConduits) {
      otherOrder.parameters = otherOrder.parameters.withConduitKey(conduitKey);
    }
  ...
  function execGetMatchedFulfillments_1ItemTo1Item_descending_leftover(
    ...
    assertEq(leftoverConsideration.length, 0, "leftoverConsideration.length");
  ...
  function execGetMatchedFulfillments_1ItemTo1ItemExcessOffer(
    ...
    Order memory otherOrder = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[1])).withAmount(200)
          )
        )
        .withTotalConsideration(
          SeaportArrays.ConsiderationItems(
  ...
  function execGetMatchedFulfillments_3ItemsTo1Item_extra(
    ...
    Order memory order = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(110)
          )
        )
        .withTotalConsideration(
          SeaportArrays.ConsiderationItems(
  ...
  function execGetMatchedFulfillments_3ItemsTo2Items(
    ...
    Order memory order = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(10),
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(90)
          )
        )
        .withTotalConsideration(
          SeaportArrays.ConsiderationItems(
  ...
  function execGetMatchedFulfillments_DoubleOrderPairs_1ItemTo1Item(
    ...
    Order memory orderTwo = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(101)
          )
        )
        .withTotalConsideration(
          SeaportArrays.ConsiderationItems(
    ...
    Order memory otherOrderTwo = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[1])).withAmount(101)
          )
        )
        .withTotalConsideration(
          SeaportArrays.ConsiderationItems(
    ...
    if (!useDifferentConduitsBetweenOrderPairs) {
      ...
      assertEq(fulfillments[1], expectedFulfillments[1], "fulfillments[1]");
      assertEq(fulfillments[2], expectedFulfillments[2], "fulfillments[2]");
      assertEq(fulfillments[3], expectedFulfillments[3], "fulfillments[3]");
    }
  ...
  function execGetMatchedFulfillments_consolidatedConsideration(
    ...
    Order memory order = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(90),
            OfferItemLib.empty().withToken(address(erc20s[1])).withAmount(10)
          )
        )
        .withConsideration(
          SeaportArrays.ConsiderationItems(
    ...
    Order memory otherOrder = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(30)
          )
        )
        .withConsideration(
          SeaportArrays.ConsiderationItems(
  ...
  function testRemainingItems_availableOrder() public {
    Order memory order1 = Order({
      parameters: OrderParametersLib
        ...
        .withOffer(
          SeaportArrays.OfferItems(
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(10),
            OfferItemLib.empty().withToken(address(erc20s[0])).withAmount(11)
          )
        )
        .withTotalConsideration(
          SeaportArrays.ConsiderationItems(
    ...
    assertEq(remainingConsideration.length, 2, "remainingConsideration.length");
    assertEq(
  ...
  function _toMatchableOrder(
    ...
    for (uint256 i = 0; i < order.parameters.offer.length; i++) {
      order.parameters.offer[i] = order.parameters.offer[i].copy().withItemType(
        ItemType.ERC20
      );
    }
