...
import {AdvancedOrder, CriteriaResolver, ReceivedItem} from "seaport-sol/src/SeaportStructs.sol";
...
import {FailureEligibilityLib, MutationEligibilityLib, Failarray, FailureDetails, FailureDetailsHelperLib, IneligibilityFilter, MutationContextDerivation, MutationContextDeriverLib} from "./FuzzMutationHelpers.sol";
...
library FuzzMutationSelectorLib {
    ...
    returns (IneligibilityFilter[] memory failuresAndFilters)
  {
    ...
    failuresAndFilters[i++] = Failure
      ...
      .withOrder(
        MutationFilters.ineligibleForConsiderationLengthNotEqualToTotalOriginal
      );
    ...
    failuresAndFilters[i++] = Failure
      ...
      .withGeneric(
        MutationFilters.ineligibleForOfferAndConsiderationRequiredOnFulfillment
      );
    ...
    failuresAndFilters[i++] = Failure.Error_OfferItemMissingApproval.withOrder(
    ...
    failuresAndFilters[i++] = Failure
      ...
      .withOrder(MutationFilters.ineligibleWhenNotAvailableOrNotContractOrder);
    ...
    failuresAndFilters[i++] = Failure
      ...
      .withOrder(MutationFilters.ineligibleWhenNotActiveTimeOrNotContractOrder);
    ...
    failuresAndFilters[i++] = Failure.UnusedItemParameters_Identifier.withOrder(
    ...
    failuresAndFilters[i++] = Failure.PartialFillsNotEnabledForOrder.withOrder(
...
library FailureDetailsLib {
    ...
    returns (FailureDetails[] memory failureDetailsArray)
  {
    ...
    failureDetailsArray[i++] = HashCalldataContractOfferer
      ...
      .withOrder(
        ...
        FuzzMutations.mutation_invalidContractOrderGenerateReverts.selector
      );
  ...
  function details_InvalidConduit(
    ...
    (address conduitAddr, ) = context.conduitController.getConduit(conduitKey);
  ...
  {
    FailureDetails memory details = (declareFailureDetails()[uint256(failure)]);
