  ...
  function fulfillAdvancedOrder(
    ...
    fulfilled = _validateAndFulfillAdvancedOrder(
      ...
      _toCriteriaResolversReturnType(_decodeCriteriaResolvers)(
        CalldataStart.pptrOffset(Offset_fulfillAdvancedOrder_criteriaResolvers)
      ),
      fulfillerConduitKey,
