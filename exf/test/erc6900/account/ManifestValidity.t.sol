...
import {BadValidationMagicValue_UserOp_Plugin, BadValidationMagicValue_PreRuntimeValidationHook_Plugin, BadValidationMagicValue_PreUserOpValidationHook_Plugin, BadValidationMagicValue_PreExecHook_Plugin, BadValidationMagicValue_PostExecHook_Plugin, BadHookMagicValue_UserOpValidationFunction_Plugin, BadHookMagicValue_RuntimeValidationFunction_Plugin, BadHookMagicValue_PostExecHook_Plugin} from "../mocks/plugins/ManifestValidityMocks.sol";
...
contract ManifestValidityTest is OptimizedTest {
    ...
    // allow"
    function test_ManifestValidity_invalid_ValidationAlwaysAllow_UserOpValidationFunction()
        public
    {
    ...
    // allow"
    function test_ManifestValidity_invalid_ValidationAlwaysAllow_PreRuntimeValidationHook()
        public
    {
    ...
    // allow"
    function test_ManifestValidity_invalid_ValidationAlwaysAllow_PreUserOpValidationHook()
        public
    {
        BadValidationMagicValue_PreUserOpValidationHook_Plugin plugin = new BadValidationMagicValue_PreUserOpValidationHook_Plugin();
    ...
    function test_ManifestValidity_invalid_ValidationAlwaysAllow_PreExecHook()
        public
    {
    ...
    function test_ManifestValidity_invalid_ValidationAlwaysAllow_PostExecHook()
        public
    {
    ...
    function test_ManifestValidity_invalid_HookAlwaysDeny_UserOpValidation()
        public
    {
        BadHookMagicValue_UserOpValidationFunction_Plugin plugin = new BadHookMagicValue_UserOpValidationFunction_Plugin();
    ...
    function test_ManifestValidity_invalid_HookAlwaysDeny_RuntimeValidationFunction()
        public
    {
        BadHookMagicValue_RuntimeValidationFunction_Plugin plugin = new BadHookMagicValue_RuntimeValidationFunction_Plugin();
    ...
    function test_ManifestValidity_invalid_HookAlwaysDeny_PostExecHook()
        public
    {
