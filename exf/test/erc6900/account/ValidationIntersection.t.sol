...
import {MockBaseUserOpValidationPlugin, MockUserOpValidation1HookPlugin, MockUserOpValidation2HookPlugin, MockUserOpValidationPlugin} from "../mocks/plugins/ValidationPluginMocks.sol";
...
contract ValidationIntersectionTest is OptimizedTest {
    ...
    function testFuzz_validationIntersect_single(
        ...
        uint256 returnedValidationData = account1.validateUserOp(
            userOp,
            uoHash,
            1 wei
        );
    ...
    function test_validationIntersect_authorizer_sigfail_validationFunction()
        public
    {
    ...
    function test_validationIntersect_timeBounds_intersect_1() public {
        ...
        assertEq(
            returnedValidationData,
            _packValidationData(address(0), start2, end1)
        );
    }
    ...
    function test_validationIntersect_authorizerAndTimeRange() public {
        ...
        oneHookPlugin.setValidationData(
            _packValidationData(goodAuthorizer, start1, end1),
            _packValidationData(address(0), start2, end2)
        );
        ...
        assertEq(
            returnedValidationData,
            _packValidationData(goodAuthorizer, start2, end1)
        );
    }

    function test_validationIntersect_multiplePreValidationHooksIntersect()
        public
    {
        uint48 start1 = uint48(10);
        uint48 end1 = uint48(20);
    ...
    function test_validationIntersect_multiplePreValidationHooksSigFail()
        public
    {
        twoHookPlugin.setValidationData(
            0, // returns OK
