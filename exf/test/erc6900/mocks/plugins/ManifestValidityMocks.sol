...
import {ManifestFunction, ManifestAssociatedFunctionType, ManifestAssociatedFunction, ManifestExecutionHook, ManifestExternalCallPermission, PluginManifest} from "@erc6900/interfaces/IPlugin.sol";
...
contract BadValidationMagicValue_PreRuntimeValidationHook_Plugin is
    BaseTestPlugin
{
    function onInstall(bytes calldata) external override {}
...
contract BadValidationMagicValue_PreUserOpValidationHook_Plugin is
    BaseTestPlugin
{
    function onInstall(bytes calldata) external override {}
