...
import {AdvancedOrder, Execution, FulfillmentComponent, ReceivedItem} from "../../../seaport-types/src/lib/ConsiderationStructs.sol";

import {_revertMissingFulfillmentComponentOnAggregation} from "../../../seaport-types/src/lib/ConsiderationErrors.sol";
...
import {Error_selector_offset, InvalidFulfillmentComponentData_error_length, InvalidFulfillmentComponentData_error_selector, MismatchedOfferAndConsiderationComponents_error_idx_ptr, MismatchedOfferAndConsiderationComponents_error_length, MismatchedOfferAndConsiderationComponents_error_selector, MissingItemAmount_error_length, MissingItemAmount_error_selector, OfferAndConsiderationRequiredOnFulfillment_error_length, OfferAndConsiderationRequiredOnFulfillment_error_selector, Panic_arithmetic, Panic_error_code_ptr, Panic_error_length, Panic_error_selector} from "../../../seaport-types/src/lib/ConsiderationErrorConstants.sol";
    ...
    if (considerationItem.amount > executionItem.amount) {
      ...
      unchecked {
        ...
        advancedOrders[targetComponent.orderIndex]
          ...
          .startAmount = (considerationItem.amount - executionItem.amount);
      }
    } else {
      ...
      unchecked {
        ...
        advancedOrders[targetComponent.orderIndex]
          ...
          .startAmount = (executionItem.amount - considerationItem.amount);
      }
  ...
  function _aggregateValidFulfillmentOfferItems(
    ...
    assembly {
      ...
      for {
        ...
        if iszero(lt(mload(mload(fulfillmentHeadPtr)), mload(advancedOrders))) {
