...
contract BasicOrderFulfiller is OrderValidator {
  ...
  function _validateAndFulfillBasicOrder() internal returns (bool) {
    ...
    uint additional = uint(additionalRecipientsItemType);
    console.log("additionalRecipientsItemType: ", additional);
  ...
  function _prepareBasicFulfillmentFromCalldata(
...

    {
      ...
      assembly {
        ...
        mstore(
          0,
          keccak256(BasicOrder_offerItem_typeHash_ptr, EIP712_OfferItem_size)
        )
  ...
  function _transferIndividual721Or1155Item(
    ...
    if (conduitKey != bytes32(0)) {
      ...
      assembly {
        ...
        mstore(
          add(callDataOffset, Conduit_execute_ConduitTransfer_offset_ptr),
  ...
  function _transferERC20AndFinalize(
    ...
    assembly {
      ...
      conduitKey := calldataload(
        sub(BasicOrder_fulfillerConduit_cdPtr, shl(OneWordShift, fromOfferer))
      )
    }
