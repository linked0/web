...
import {Order, OfferItem, OrderParameters, ConsiderationItem, OrderComponents, FulfillmentComponent} from "seaport-types/src/lib/ConsiderationStructs.sol";
...
contract FulfillAvailableOrder is BaseOrderTest {
  ...
  function testFulfillAndAggregateTwoOrdersViaFulfillAvailableOrdersEthToErc1155(
    ...
    test(
      this.fulfillAndAggregateTwoOrdersViaFulfillAvailableOrdersEthToErc1155,
      Context(referenceConsideration, args, ItemType(0))
    );
    test(
      this.fulfillAndAggregateTwoOrdersViaFulfillAvailableOrdersEthToErc1155,
