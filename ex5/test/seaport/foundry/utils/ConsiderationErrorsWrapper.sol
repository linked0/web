...
import {_revertBadFraction, _revertConsiderationLengthNotEqualToTotalOriginal, _revertConsiderationNotMet, _revertCriteriaNotEnabledForItem, _revertInsufficientNativeTokensSupplied, _revertInvalidBasicOrderParameterEncoding, _revertInvalidCallToConduit, _revertInvalidConduit, _revertInvalidContractOrder, _revertInvalidERC721TransferAmount, _revertInvalidMsgValue, _revertInvalidNativeOfferItem, _revertInvalidProof, _revertInvalidTime, _revertMissingFulfillmentComponentOnAggregation, _revertMissingOriginalConsiderationItems, _revertNoReentrantCalls, _revertNoSpecifiedOrdersAvailable, _revertOrderAlreadyFilled, _revertOrderCriteriaResolverOutOfRange, _revertOrderIsCancelled, _revertOrderPartiallyFilled, _revertPartialFillsNotEnabledForOrder, _revertUnusedItemParameters} from "seaport-types/src/lib/ConsiderationErrors.sol";
...
contract ConsiderationErrorsWrapper {
  ...
  function __revertConsiderationNotMet(
    ...
    _revertConsiderationNotMet(orderIndex, considerationIndex, shortfallAmount);
  }
