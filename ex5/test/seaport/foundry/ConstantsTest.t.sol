...
contract ConstantsTest is BaseConsiderationTest {
  ...
  function testInvalidFulfillmentComponentData_error_selector() public {
    _test(
      ...
      FulfillmentApplicationErrors.InvalidFulfillmentComponentData.selector
    );
  }
  ...
  function testConsiderationCriteriaResolverOutOfRange_error_selector() public {
    _test(
      ConsiderationCriteriaResolverOutOfRange_error_selector,
      CriteriaResolutionErrors.ConsiderationCriteriaResolverOutOfRange.selector
    );
  }
  ...
  function testMissingOriginalConsiderationItems_error_selector() public {
    _test(
      MissingOriginalConsiderationItems_error_selector,
      ConsiderationEventsAndErrors.MissingOriginalConsiderationItems.selector
    );
  }
  ...
  function testInvalidBasicOrderParameterEncoding_error_selector() public {
    _test(
      ...
      ConsiderationEventsAndErrors.InvalidBasicOrderParameterEncoding.selector
    );
  }
  ...
  function testRatifyOrder_selector() public {
    _test(ratifyOrder_selector, ContractOffererInterface.ratifyOrder.selector);
  }
