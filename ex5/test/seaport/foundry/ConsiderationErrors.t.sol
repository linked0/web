...
import {ConsiderationErrorsWrapper} from "./utils/ConsiderationErrorsWrapper.sol";
...
contract ConsiderationErrors is BaseOrderTest, ConsiderationErrorsWrapper {
  ...
  function test_revertInvalidCallToConduit() public {
    vm.expectRevert(
      abi.encodeWithSignature("InvalidCallToConduit(address)", someAddress)
    );
  ...
  function test_revertInvalidContractOrder() public {
    vm.expectRevert(
      abi.encodeWithSignature("InvalidContractOrder(bytes32)", someBytes32)
    );
  ...
  function test_revertOrderPartiallyFilled() public {
    vm.expectRevert(
      abi.encodeWithSignature("OrderPartiallyFilled(bytes32)", someBytes32)
    );
