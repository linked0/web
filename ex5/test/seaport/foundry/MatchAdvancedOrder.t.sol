...
import {AdvancedOrder, OfferItem, OrderParameters, ConsiderationItem, OrderComponents, CriteriaResolver, FulfillmentComponent} from "seaport-types/src/lib/ConsiderationStructs.sol";
...
contract MatchAdvancedOrder is BaseOrderTest {
  ...
  function matchOrdersAscendingDescendingOfferAmountPartialFill(
    ...
    assertEq(balanceAfterOrder - balanceBeforeOrder, currentAmount.mul(2) / 10);
  }
