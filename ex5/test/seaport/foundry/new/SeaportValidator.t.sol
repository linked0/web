...
import {ConduitIssue, ConsiderationIssue, ErrorsAndWarnings, ErrorsAndWarningsLib, GenericIssue, ERC20Issue, ERC721Issue, ERC1155Issue, IssueParser, OfferIssue, SeaportValidator, SignatureIssue, StatusIssue, TimeIssue, NativeIssue} from "../../../contracts/helpers/order-validator/SeaportValidator.sol";

import {ConduitControllerInterface} from "seaport-sol/src/ConduitControllerInterface.sol";

import {SeaportValidatorHelper} from "../../../contracts/helpers/order-validator/lib/SeaportValidatorHelper.sol";

import {IssueStringHelpers} from "../../../contracts/helpers/order-validator/lib/SeaportValidatorTypes.sol";

import {ConsiderationItemLib, OfferItemLib, OrderParametersLib, OrderComponentsLib, OrderLib, OrderType, AdvancedOrderLib, ItemType} from "seaport-sol/src/SeaportSol.sol";
...
contract SeaportValidatorTestSuite is BaseOrderTest, SeaportValidatorTest {
  ...
  function test_isValidOrder_erc721_identifierDNE() public {
    ...
    order.parameters.consideration[0].identifierOrCriteria = type(uint256).max;
