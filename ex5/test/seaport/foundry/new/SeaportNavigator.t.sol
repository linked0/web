...
import {AdvancedOrderLib, ConsiderationInterface, ConsiderationItemLib, CriteriaResolver, OfferItemLib, OrderComponentsLib, OrderLib, OrderParametersLib} from "seaport-sol/src/SeaportSol.sol";

import {ConsiderationItem, OfferItem, OrderParameters, OrderComponents, Order, AdvancedOrder} from "seaport-sol/src/SeaportStructs.sol";

import {ItemType} from "seaport-sol/src/SeaportEnums.sol";

import {AggregationStrategy, FulfillAvailableStrategy, FulfillmentStrategy, MatchStrategy} from "seaport-sol/src/fulfillments/lib/FulfillmentLib.sol";

import {NavigatorRequest, NavigatorResponse, SeaportNavigator} from "../../../contracts/helpers/navigator/SeaportNavigator.sol";

import {TokenIdNotFound} from "../../../contracts/helpers/navigator/lib/CriteriaHelperLib.sol";

import {NavigatorAdvancedOrder, NavigatorAdvancedOrderLib} from "../../../contracts/helpers/navigator/lib/NavigatorAdvancedOrderLib.sol";

import {OrderStructureLib} from "../../../contracts/helpers/navigator/lib/OrderStructureLib.sol";
  ...
  SeaportNavigatorTest
{
  ...
  function test_simpleOrderWithNativeReturned() public {
    ...
    AdvancedOrder memory advancedOrder = order.toAdvancedOrder(1, 1, "dummy");
    ...
    assertEq(
      ...
      abi.encodeCall(
        ...
        (advancedOrder, new CriteriaResolver[](0), bytes32(0), address(this))
      ),
      "unexpected suggested calldata"
    );
  ...
  function test_inferredCriteria() public {
    NavigatorAdvancedOrder[] memory orders = new NavigatorAdvancedOrder[](1);
    AdvancedOrder memory advancedOrder = OrderLib
      .fromDefault(SINGLE_ERC721_WITH_CRITERIA_SINGLE_ERC721_WITH_CRITERIA)
      .toAdvancedOrder(1, 1, "");
    orders[0] = NavigatorAdvancedOrderLib.fromAdvancedOrder(advancedOrder);
