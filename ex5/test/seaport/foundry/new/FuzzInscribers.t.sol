...
import {ConsiderationItemLib, OfferItemLib, OrderComponentsLib, OrderLib} from "seaport-sol/src/SeaportSol.sol";

import {AdvancedOrder, ConsiderationItem, CriteriaResolver, OfferItem, OrderComponents} from "seaport-sol/src/SeaportStructs.sol";
...
import {FuzzTestContext, FuzzTestContextLib} from "./helpers/FuzzTestContextLib.sol";
...
contract FuzzHelpersTest is BaseOrderTest {
  ...
  function _setRawSyntheticStorageValues(
    ...
    rawStorageValues.rawSyntheticOrderStatusAfterPartialFulfillment = vm.load(
      address(context.seaport),
      orderHashStorageSlot
    );
