...
import {NonMatchSelector_MagicMask, NonMatchSelector_InvalidErrorValue} from "seaport-types/src/lib/ConsiderationConstants.sol";
...
contract NonMatchSelectorTest is Test {
  ...
  function testSelectorMatchAdvancedOrders() public {
    _testSelector(ConsiderationInterface.matchAdvancedOrders.selector, false);
  }

  function testSelectorFulfillAvailableOrders() public {
    _testSelector(ConsiderationInterface.fulfillAvailableOrders.selector, true);
  }
